...
const sleep_icon = document.querySelector(".sleep-description i");
const sleepList = [];
...
.then((data) => {
    for (let i = 0; i < data.length; i++) {
      ...
      story_authors[i].dataset.sleepID = data[i].id;
      console.log(data[i].documentID)
    }
...
sleep_icon.addEventListener("click", function() {
    console.log(sleep_icon.previousElementSibling)
})
